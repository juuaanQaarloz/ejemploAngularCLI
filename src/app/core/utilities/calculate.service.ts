...
export class CalculateService {
   ...
   */
  calculateRFC(apellidoPaterno: string, apellidoMaterno: string, nombre: string, fechaNacimiento: string) {
    ...
    if (typeof(apellidoPaterno) !== 'undefined' && typeof (apellidoMaterno) !== 'undefined' && typeof (nombre) === 'string' && typeof (fechaNacimiento) === 'string') {
      ...
      if (!this.validateService.nullUndefinedOrEmptyValidation(fechaNacimiento.match(dateFormat2))) {
