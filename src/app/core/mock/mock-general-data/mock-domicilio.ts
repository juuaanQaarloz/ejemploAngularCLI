...
export const DatosDomicilio: Field[] = [
  ...
  },
  {
    ...
    name: 'emailCheck',
    orderAppearance: 11,
    label: '¿El cliente requiere copia de su solicitud vía coreo?',
    type: 'checkbox',
    required: false,
    placeholder: '',
    length: '',
  ...
  },
  {
    ...
    styleClass: '',
    styleClassError: '',
    message: 'El correo eléctronico es requerido',
    messageClass: '',
    messageError: '',
    messageErrorClass: '',
    renderConditions: '',
  ...
  },
  {
    ...
    styleClass: '',
    styleClassError: '',
    message: 'El correo eléctronico  de confirmación es requerido',
    messageClass: '',
    messageError: '',
    messageErrorClass: '',
    renderConditions: '',
