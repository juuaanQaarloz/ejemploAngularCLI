...
export const BeneficiaryFieldsF: Field[] = [
  {
    ...
    requiredConditions: '(beneficiaryType=F)',
    enableConditions: '',
    entity: '',
    entityField: '',
    value: true
  ...
  },
  {
    ...
    messageError: '',
    messageErrorClass: '',
    // renderConditions: '(beneficiaryType=F,&,beneficiaryRelationshipF=false)',
    renderConditions: '(beneficiaryType=F)',
    requiredConditions: '(beneficiaryType=F)',
    enableConditions: '',
    entity: '',
  ...
  {
    id: 'field-125',
    idHtml: 'txtBeneficiaryRelashionshipF',
    name: 'espBeneficiaryRelationshipF',
    orderAppearance: 5,
    label: 'Especificar',
    type: 'text',
    required: false,
    ...
    messageError: '',
    messageErrorClass: '',
    renderConditions: '(beneficiaryRelationshipF=29)',
    requiredConditions: '',
    enableConditions: '',
    entity: '',
    entityField: '',
