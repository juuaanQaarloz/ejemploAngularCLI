...
export class AppConstants {
  ...
  public static readonly URL_SERVICE: string  = 'http://localhost:8080/CP-DES_PRIV_SVS_6979-0.0.1';
  // public static readonly URL_SERVICE_DEV: string = 'http://10.215.104.61:35741/cp-desws-priv';
  public static readonly URL_SERVICE_DEV: string = 'http://localhost:8080/CP-DES_PRIV_SVS_6979-0.0.1';
