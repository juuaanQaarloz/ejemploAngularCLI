...
export const statements2: Field[] = [
  {
    ...
    orderAppearance: 8,
    label: '¿Actuas por cuenta de un tercero?*',
    type: 'radio',
    required: true,
    placeholder: '',
    length: '',
...
export const statements3: Field[] = [
  {
    ...
    orderAppearance: 9,
    label: '¿Eres el proveedor de recursos con los que se financiarán las obligaciones, pago o aportaciones contrídas con MetLife?*',
    type: 'radio',
    required: true,
    placeholder: '',
    length: '',
