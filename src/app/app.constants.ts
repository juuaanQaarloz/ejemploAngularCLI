...
export class AppConstants {
  public static readonly URL_SERVICE: string = 'https://int.des.metlife.com/despriv';
  ...
  public static readonly URL_SERVICE_DEV: string = 'https://int.des.metlife.com/despriv';
}
